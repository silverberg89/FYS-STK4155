...
\\
\par
We can also conclude that the accuracy score metric used throughout this project, may not be the most suitable for this dataset. The testing of the F1 score metric gave clear indications that further analysis should explore different metrics to tackle this dataset.