...
\\
\par
This was produced by the function "ExtraTreesClassifier" by sklearn.
\\
\par
\textbf{[2] Extended results for variable analysis:}
\begin{figure}[H]
  \centering
  \subfloat[Minimum imapct for flipped case]{\includegraphics[width=0.5\textwidth]{pictures/results/min_flipp}\label{fig:f3}}
  \hfill
  \subfloat[Maximum imapct for 2016]{\includegraphics[width=0.5\textwidth]{pictures/results/max_16}\label{fig:f4}}
   \caption{Single variables}
\end{figure}
\begin{figure}[H]
  \centering
  \subfloat[Minimum imapct for 2016]{\includegraphics[width=0.5\textwidth]{pictures/results/min_16}\label{fig:f3}}
  \hfill
  \subfloat[Minimum imapct for 2012]{\includegraphics[width=0.5\textwidth]{pictures/results/min_12}\label{fig:f4}}
   \caption{Single variables}
\end{figure}

\textbf{[3] List of variables indices:}\\
PST = Population\\
POP = Population\\
AGE = Age data\\
SEX = Gender data\\
...
\\
\par
All variables can in full be found at:\\
...
\newpage
\textbf{[5] Map of miss classifications:}\\
\begin{figure}[H]
\centering
{\includegraphics[scale=0.33]{pictures/results/pred}\label{fig:f3}}
\caption{Counties that the ??? could not classify}
\end{figure}
