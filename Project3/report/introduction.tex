...
\\
\par
Models that are capable of predicting can help humans in decision making, reduce the number of experiments and observations needed and could replace humans in doing boring and repetitive tasks which humans normally are not good at. Or as in this case, reproduce results that allows us to analyse the information behind a certain outcome, such as the presidential election in the United States.  
\\
\par
